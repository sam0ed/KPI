...
def run_simulation() -> None:
    ...
    process4 = ProcessElement(max_queue_size=1, num_handlers=2, get_delay=partial(
        random.expovariate, lambd=1.0 / 1.0))

    create1.add_next_element(process1)
    process1.add_next_element(process2)
    process2.add_next_element(process3, proba=0.9)
    process2.add_next_element(process4, proba=0.1)
    ...
    process4.add_next_element(process1, proba=0.1)
