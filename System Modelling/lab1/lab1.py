...
def analyze_data(data, theoretical_dist, params, title, parameter_count):
    ...
    df = len(observed) - 1 - parameter_count  # Degrees of freedom

    # Calculate the critical value for the given alpha and df
...
def main():
    ...
    chi2_stat_1, p_value_1, critical_value_1 = analyze_data(data_1, 'exponential', {'lambda': lambd}, 'Exponential Distribution - Method 1', 1)
    ...
    chi2_stat_2, p_value_2, critical_value_2 = analyze_data(data_2, 'normal', {'mean': a, 'std': sigma}, 'Normal Distribution - Method 2', 2)
    ...
    chi2_stat_3, p_value_3, critical_value_3 = analyze_data(data_3, 'uniform', {}, 'Uniform Distribution - Method 3', 0)

    # Display Chi-square results
    chi2_results = {
        'Method 1 (Exponential)': (chi2_stat_1, p_value_1, critical_value_1, chi2_stat_1 > critical_value_1),
        'Method 2 (Normal)': (chi2_stat_2, p_value_2, critical_value_2, chi2_stat_2 > critical_value_2),
        'Method 3 (Uniform)': (chi2_stat_3, p_value_3, critical_value_3, chi2_stat_3 > critical_value_3)
    }

    chi2_df = pd.DataFrame(chi2_results, index=['Chi-Square', 'p-value', 'Critical X2', 'Reject H0'])
    print(chi2_df)
